...
public class weakHashMapOperations {
	public static void main(String[] args) {
		WeakHashMap<newEmployees, Integer> salaryMap = new WeakHashMap<>();
        ...
        salaryMap.forEach((x,y) -> System.out.println((x == null ? "Key Not Found " : x) + " -> " + (y == null ? "Value Not Found" : y)));
        System.gc();
        threadSimulation();
